...
JSONIQ=jsoniq.cmo jsoniq_focus.cmo jsoniq_semantics.cmo jsoniq_syntax.cmo jsoniq_suggestions.cmo jsoniq_lis.cmo

FLAGS= -package yojson -I ../../../lib -I ../../core -I ../../core/webapp
