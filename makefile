...
JSONIQ=jsoniq.cmo jsoniq_focus.cmo jsoniq_semantics.cmo jsoniq_syntax.cmo jsoniq_suggestions.cmo jsoniq_lis.cmo jsoniq_files.cmo

FLAGS= -package yojson,ppx_deriving_yojson,csv -I ../../../lib -I ../../core -I ../../core/webapp
